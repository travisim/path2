class wasm_RRT_graph extends wasm_Pathfinder{
  ...
  static get configs(){
		...
		configs.push(
      {uid: "generate_visbility_graph", displayName: "Generate RRT Graph", options: "button", description: `Generates the RRT graph without searching.`},
      {uid: "download_visbility_data", displayName: "Download RRT Data", options: "button", description: `Download the generated RRT data`},
